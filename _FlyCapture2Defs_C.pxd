...
cdef extern from "FlyCapture2Defs_C.h":
    ...
    ctypedef void *fc2TopologyNodeContext;
    ...
    cdef enum _fc2PortType:
        NOT_CONNECTED
        CONNECTED_TO_PARENT
        CONNECTED_TO_CHILD

    ctypedef _fc2PortType fc2PortType

    cdef enum _fc2NodeType:
        COMPUTER
        BUS
        CAMERA
        NODE

    ctypedef _fc2NodeType fc2NodeType
    ...
    ctypedef _fc2CameraStats fc2CameraStats
    ...
    cdef struct _fc2BMPOption:
        BOOL indexedColor_8bit
        unsigned int reserved[16]

    ctypedef _fc2BMPOption fc2BMPOption
    ...
    ctypedef void (*fc2CameraEventCallback) (void *)

    cdef struct _fc2EventOptions:
        fc2CameraEventCallback EventCallbackFcn
        char *EventName
        void *EventUserData
        size_t EventUserDataSize

    ctypedef _fc2EventOptions fc2EventOptions

    cdef struct _fc2EventCallbackData:
        void *EventUserData
        size_t EventUserDataSize
        char *EventName
    ...
    ctypedef _fc2EventCallbackData fc2EventCallbackData
